...
public static class ArraysTester {
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        // for loop iterates through parameters and adds them to list
    ...
    private static void RotateListRight(List<int> data, int amount)
    {
        ...
        // GetRange creates new list with parameter amounts 
        var part = data.GetRange(0, amount);
        // RemoveRange takes out the specified amount 
        data.RemoveRange(0, amount);
        // AddRange adds the new list from GetRange function and appends it to end of listSe
        data.AddRange(part);
